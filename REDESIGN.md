...
interface User {
  userId: string;              // Cognito sub (UUID) - String (Partition Key)
...
interface Assessment {
  ...
  feedback: Record<string, Record<string, Record<number, {
    evidence?: string;
...
interface AssessmentReport {
  ...
  variance: Record<string, Record<string, { // Map of Maps
...
interface ConfigVersion {
  ...
  parsedConfig: {              // Cached parsed structure - Map
