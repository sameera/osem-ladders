    ...
    const handleDownloadPDF = async () => {
        ...
        if (!reportElement) {
            ...
            for (const element of possibleElements) {
                if (
                    element.innerHTML.includes("Assessment Report") ||
        ...
        try {
            ...
            document.documentElement.className = originalHtmlClass.replace(
                "dark",
                ""
            );

            // Find and modify the grid layout to single column for PDF
            const gridElements = reportElement.querySelectorAll(
