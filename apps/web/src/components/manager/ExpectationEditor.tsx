...
interface ExpectationEditorProps {
  ...
  index: number;
  onChange: (index: number, field: keyof Expectation, value: string | number) => void;
  ...
  return (
    <div className="border rounded-lg p-4 space-y-3 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        {/* Level Title */}
        <div className="space-y-2">
          <Label htmlFor={`expectation-${index}-title`}>
            Title <span className="text-red-500">*</span>
          </Label>
          <Input
            id={`expectation-${index}-title`}
            type="text"
      ...
      {expectation.description !== undefined && (
        <div className="space-y-2">
